...
class SampleController extends Controller
{
    ...
    function validate_registration(Request $request)
    {
        ...
        User::create([
            ...
            'avatar' =>  isset($data['email']) ? Gravatar::get('email@example.com') : null,
            'avatar_type' => isset($data['email']) ? User::GRAVATAR : null,
        ]);
    ...
    function validate_login(Request $request)
    {
        ...
        if(Auth::attempt($credentials))
        {
            ...
            User::query()->where('id', Auth::id())->update([ 'token' => $token ]);
